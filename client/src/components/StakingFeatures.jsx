...
export default function StakingFeatures() {
  ...
  return (
    <section id="stakingFeatures" className="py-20 bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-xl">
            Experience reliable Solana staking
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className="bg-neutral-800 rounded-xl p-8 hover:transform hover:scale-105 transition-all duration-300"
            >
              <div className="h-14 w-14 bg-purple-500/20 rounded-lg flex items-center justify-center mb-6">
